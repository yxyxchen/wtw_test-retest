...
# read table and run
df = read.csv(file.path("data", "selfreport_sess1.csv"), row.names = 1)
...
write_csv(resdf, file.path("..", "analysis_log", "MCQ.csv"))
